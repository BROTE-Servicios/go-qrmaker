...
// Estructura para almacenar el historial de códigos QR
...
func generateQRCode(w http.ResponseWriter, r *http.Request) {
    ...
    // Guardar el código QR en el historial
    qrHistory = append(qrHistory, vcard)
}
...
func historyHandler(w http.ResponseWriter, r *http.Request) {
    // Mostrar el historial de códigos QR generados
    for _, qr := range qrHistory {
        fmt.Fprintln(w, qr)
    }
}
